...
export default function ProductComments({ productId }: { productId: string }) {
  ...
  const [user, setUser] = useState<{ _id?: string; id?: string; name?: string; email?: string; profileImage?: string } | null>(null);
                ...
                {c.isEditing ? (
                  ...
                  <>
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      {/* show edit/delete only for current user's comments */}
